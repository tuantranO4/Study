    ...
    public MainWindow() throws IOException{
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent ke) {
                ...
                Direction d = null;
                switch (kk){
                    case KeyEvent.VK_LEFT:  currDir = d = Direction.LEFT; break;
                    case KeyEvent.VK_RIGHT: currDir = d = Direction.RIGHT; break;
                    case KeyEvent.VK_UP:    currDir = d = Direction.UP; break;
                    case KeyEvent.VK_DOWN:  currDir = d = Direction.DOWN; break;
