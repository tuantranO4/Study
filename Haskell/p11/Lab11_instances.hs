...
instance Show Person where
    show (Person n a) = "Name: " ++ n ++ ", Age: " ++ show a --string 
...
--main = print ((BLeaf 1) == (BLeaf 1)) -- True
--main = print ((BNode (BLeaf 1) (BLeaf 2)) == (BNode (BLeaf 1) (BLeaf 3))) -- False
...
-- 7. Define an enumeration type TrafficLight that has the following values: Red, Yellow and Green.
...
--main = do
   ...
   --  print (fmap (++ " tree") (BNode (BLeaf "small") (BLeaf "big")))  
    -- Should print: Node (Leaf "small tree") (Leaf "big tree")


-- Implement the fmap function for TrafficLightWithValue
